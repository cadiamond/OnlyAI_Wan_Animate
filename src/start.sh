...
# === 2xLiveActionV1_SPAN_490000 ===
if [ ! -f "$NETWORK_VOLUME/ComfyUI/models/upscale_models/2xLiveActionV1_SPAN_490000.pth" ]; then
    if [ -f "/2xLiveActionV1_SPAN_490000.pth" ]; then
        mv "/2xLiveActionV1_SPAN_490000.pth" "$NETWORK_VOLUME/ComfyUI/models/upscale_models/2xLiveActionV1_SPAN_490000.pth"
        echo "Moved 2xLiveActionV1_SPAN_490000.pth to the correct location."
    else
        echo "2xLiveActionV1_SPAN_490000.pth not found in the root directory."
    fi
else
    echo "2xLiveActionV1_SPAN_490000.pth already exists. Skipping."
fi
...
SOURCE_DIR="/OnlyAI_Wan_Animate/workflows"
